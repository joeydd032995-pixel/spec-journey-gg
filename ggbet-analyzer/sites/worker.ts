...
import * as researchSnapshot from '../app/api/research-snapshot/route';
...
const routes: Record<string, any> = {
 ...
 '/api/research-snapshot': researchSnapshot,
};
export default {
